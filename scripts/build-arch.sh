...
cargo install sccache --version 0.4.1 --no-default-features --target "$1"
printf "\n"
...
printf "\n"
cargo install cargo-audit --version 0.17.5 --target "$1"
printf "\n"
cargo install cargo-watch --version 8.4.0 --target "$1"
printf "\n"
# For doing live reload of documentation
cargo install penguin-app --version 0.2.5 --target "$1"
printf "\n"
